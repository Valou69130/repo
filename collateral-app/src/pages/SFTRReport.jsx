...
function buildSFTRRow(repo, assets) {
  ...
  return {
    ...
    reportingCptyLei:       "BDEMO-LEI-RO-BNR-001",
...
<sftr:SFTRReport
  ...
  <sftr:Header>
    <sftr:ReportingEntity>${rows[0]?.reportingCptyLei ?? "BDEMO-LEI-RO-BNR-001"}</sftr:ReportingEntity>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="rounded-md shadow-sm">
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-slate-500">LEI</span><span className="font-mono text-xs">BDEMO-LEI-RO-BNR-001</span></div>
