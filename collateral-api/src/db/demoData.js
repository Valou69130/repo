...
const ASSETS = [
  ...
  { id:'AST-004', isin:'EUROMMF001', name:'EUR Liquidity Fund A', issuer:'Money Market Fund', type:'MMF', currency:'EUR', quantity:2100000, market_value:2100000, haircut:6, eligibility:'Counterparty restricted', custody:'Global Custody', status:'Available', integration_json: JSON.stringify({ sourceSystem:'Euroclear SWIFT feed', sourceLedger:'Euroclear Bank holding account', settlementState:'confirmed', reconState:'pending', custodyLocation:'Euroclear Bank SA/NV', lastSyncTs:'2026-04-06T08:30:00', externalRef:'ECL-MMF001-20260406' }) },
